...
export default async function handler(req, res) {
  ...
  //   .get(
  //     "/api/homepage?populate[0]=Banner&populate[1]=Banner.Ai_technology_image&populate[2]=About_us&populate[3]=About_us.Achievements_widget&populate[4]=About_us.Achievements_widget.Icon&populate[5]=About_us.Featured_image&populate[6]=About_us.Redirect_link&populate[7]=Testimonials&populate[8]=Testimonials.Testimonials&populate[9]=Testimonials.Logo_slider1&populate[10]=Testimonials.Logo_slider2&populate[11]=Branches&populate[12]=Branches.Background_image&populate[13]=Work_together&populate[14]=Work_together.Email_id&populate[15]=Work_together.Phone_number&populate[16]=Work_together.Contact_cta&populate[17]=Service&populate[18]=Service.Title_icon&populate[19]=Service.Technology_images&populate[20]=Seo&populate[21]=Banner.Projects&"
  //   )
  //   .then(function (response) {
  //     // handle success
  //     return response?.data?.data;
